 ...
 */
public class TestIdentityManagerImpl implements IdentityManager {


    private static final Logger log = Logger.getLogger(TestIdentityManagerImpl.class);

    public TestIdentityManagerImpl() {
    }
