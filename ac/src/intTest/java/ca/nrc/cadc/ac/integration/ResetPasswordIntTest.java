...
public class ResetPasswordIntTest
{
    ...
    private static final String EMAIL_ADDRESS = "user1@nrc.ca";
    private static final String WEAK_PASSWORD = "b7SP83c";
    private static final String NEW_PASSWORD = "b7SP83cA";
        ...
        throws Exception
    {
        ...
        getServiceURL = new URL(postServiceURL.toExternalForm() +
                                    "?emailAddress=" + NetUtil.encode(EMAIL_ADDRESS));
        log.info("getServiceUrl: " + getServiceURL);
        log.info("postServiceUrl: " + postServiceURL);

        certFile = FileUtil.getFileFromResource("user1.pem", ResetPasswordIntTest.class);
    ...
    private void getDelegationToken(final ByteArrayOutputStream out) throws Exception
    {
        ...
        Subject.doAs(opsSubject, new PrivilegedExceptionAction<Void>()
        {
            public Void run() throws Exception
            {
                HttpDownload httpGet = new HttpDownload(getServiceURL, out);
                httpGet.run();
                log.info("scoped token: " + out.toString());
                return null;
            }
        });
    }
    ...
    public void testResetPassword() throws Exception
    {
        ...
        Subject.doAs(s, new RunnableAction(post));
